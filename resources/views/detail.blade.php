                ...
                <div>
                    ...
                    <div class="progress" style="height: 1.5rem;">
                        <div class="progress-bar progress-bar-striped progress-bar-animated"
                            style="width: {{ $width2 }}%;" role="progressbar" aria-valuenow="0" aria-valuemin="0"
                            aria-valuemax="100">{{ $city->detail->racism }}</div>
                    </div>
                </div>
                <div>
                    ...
                    <div class="progress" style="height: 1.5rem;">
                        <div class="progress-bar progress-bar-striped progress-bar-animated"
                            style="width: {{ $width2 }}%;" role="progressbar" aria-valuenow="0" aria-valuemin="0"
                            aria-valuemax="100">{{ $city->detail->traffic }}</div>
                    </div>
            ...
            <div class="col-md-6 col-lg-3 mt-4">
                ...
                <div>
                    ...
                    <div class="progress" style="height: 1.5rem;">
                        <div class="progress-bar progress-bar-striped progress-bar-animated"
                            style="width: {{ $width2 }}%;" role="progressbar" aria-valuenow="0" aria-valuemin="0"
                            aria-valuemax="100">{{ $city->detail->hospital }}</div>
                    </div>
                ...
                <div>
                    ...
                    <div class="progress" style="height: 1.5rem;">
                        <div class="progress-bar progress-bar-striped progress-bar-animated"
                            style="width: {{ $width2 }}%;" role="progressbar" aria-valuenow="0" aria-valuemin="0"
                            aria-valuemax="100">{{ $city->detail->education }}</div>
                    </div>
                ...
                <div>
                    ...
                    <div class="progress" style="height: 1.5rem;">
                        <div class="progress-bar progress-bar-striped progress-bar-animated {{ $width1 }}"
